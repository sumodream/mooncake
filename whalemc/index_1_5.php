...
<body style="overflow: hidden">
	...
	<div id="pageWrap">
		...
		<img class="background1 bg" src="img/bg2.jpg" />
			<div class="zoom-page">
				<div class="case1">
					<div class="pt-page-scaleUpIcon img3-1 imgcomm "></div>
					<div class="opacityOnIcon img3-2 imgcomm " style="width: 221px;background-position-x: -225px;"></div>
		...
		<img class="background1 bg" src="img/bg2.jpg" />
			<div class="zoom-page">
				...
				<div class="pt-page-scaleUpIcon img4-04 imgcomm " style="background-position-y: -3px;"></div>
				<div class="arrow pt-page-moveIconUp img-arrow img4-05"></div>
				<div class="pt-page-scaleUpIcon img4-06 imgcomm" style="background-position-y: -1141px;"></div>
				<img src="img/ss.gif" class="moon_jj" style="left:-60px;"/>
			</div>
		</div>
		...
		<audio id="audio1" src="img/S12s.mp3" style="display:none;"></audio>
		<audio id="audio2" src="img/yes.mp3" style="display:none;"></audio>
	</div>
	<!-- 页面内容  end-->
	<!-- 统计访问量-->
